...
export default class VideoPlayer extends Component {
  ...
  renderCenterControls() {
    const leftSkip = this.props.leftSkip || this.renderSkipButtons('back');
    const rightSkip = this.props.rightSkip || this.renderSkipButtons('forward');
    ...
    return (
      <Animated.View
        ...
        <View style={styles.controls.centerContainer}>
          {leftSkip}
          {rightSkip}
        </View>
      </Animated.View>
